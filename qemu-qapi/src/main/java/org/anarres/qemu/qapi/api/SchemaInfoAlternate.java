 ...
 * Autogenerated class.
 *
 * <pre>QApiTypeDescriptor{name=SchemaInfoAlternate, data={members=[SchemaInfoAlternateMember]}, innerTypes=null}</pre>
 */
// QApiTypeDescriptor{name=SchemaInfoAlternate, data={members=[SchemaInfoAlternateMember]}, innerTypes=null}
