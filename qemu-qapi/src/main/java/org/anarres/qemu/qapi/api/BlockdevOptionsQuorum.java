 ...
 * Autogenerated class.
 *
 * <p><pre>QApiTypeDescriptor{name=BlockdevOptionsQuorum, data={*blkverify=bool, children=[BlockdevRef], vote-threshold=int, *rewrite-corrupted=bool, *read-pattern=QuorumReadPattern}, innerTypes=null}</pre></p>
 */
