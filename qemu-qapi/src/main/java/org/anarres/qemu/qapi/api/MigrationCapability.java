 ...
 * Autogenerated class.
 *
 * <pre>QApiEnumDescriptor{name=MigrationCapability, data=[xbzrle, rdma-pin-all, auto-converge, zero-blocks, compress, events, postcopy-ram, x-colo, release-ram, block, return-path, pause-before-switchover, x-multifd, dirty-bitmaps, postcopy-blocktime], fields=null}</pre>
 */
...
public enum MigrationCapability {
	...
	postcopy_blocktime("postcopy-blocktime"),
	__UNKNOWN("<unknown>");
