 ...
 * Autogenerated class.
 *
 * <pre>QApiTypeDescriptor{name=SchemaInfoObjectMember, data={name=str, type=str, *default=any}, innerTypes=null}</pre>
 */
// QApiTypeDescriptor{name=SchemaInfoObjectMember, data={name=str, type=str, *default=any}, innerTypes=null}
