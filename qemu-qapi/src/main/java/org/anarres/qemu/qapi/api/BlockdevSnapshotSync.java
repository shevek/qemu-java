 ...
 * Autogenerated class.
 *
 * <pre>QApiTypeDescriptor{name=BlockdevSnapshotSync, data={*device=str, *node-name=str, snapshot-file=str, *snapshot-node-name=str, *format=str, *mode=NewImageMode}, innerTypes=null}</pre>
 */
// QApiTypeDescriptor{name=BlockdevSnapshotSync, data={*device=str, *node-name=str, snapshot-file=str, *snapshot-node-name=str, *format=str, *mode=NewImageMode}, innerTypes=null}
