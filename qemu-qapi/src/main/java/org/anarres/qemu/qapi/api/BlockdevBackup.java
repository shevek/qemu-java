 ...
 * Autogenerated class.
 *
 * <pre>QApiStructDescriptor{name=BlockdevBackup, data={*job-id=str, device=str, target=str, sync=MirrorSyncMode, *speed=int, *compress=bool, *on-source-error=BlockdevOnError, *on-target-error=BlockdevOnError}, innerTypes=null, fields=null, base=null}</pre>
 */
// QApiStructDescriptor{name=BlockdevBackup, data={*job-id=str, device=str, target=str, sync=MirrorSyncMode, *speed=int, *compress=bool, *on-source-error=BlockdevOnError, *on-target-error=BlockdevOnError}, innerTypes=null, fields=null, base=null}
...
public class BlockdevBackup extends QApiType {
	...
	public BlockdevBackup(java.lang.String jobId, java.lang.String device, java.lang.String target, MirrorSyncMode sync, java.lang.Long speed, java.lang.Boolean compress, BlockdevOnError onSourceError, BlockdevOnError onTargetError) {
		this.jobId = jobId;
		this.device = device;
		this.target = target;
		this.sync = sync;
