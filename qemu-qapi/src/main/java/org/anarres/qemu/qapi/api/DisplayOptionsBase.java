 ...
 * Autogenerated class.
 *
 * <pre>QApiTypeDescriptor{name=DisplayOptionsBase, data={type=DisplayType, *full-screen=bool, *window-close=bool, *gl=DisplayGLMode}, innerTypes=null}</pre>
 */
...
public class DisplayOptionsBase extends QApiType {
	...
	@Nonnull
	public DisplayOptionsBase withGl(DisplayGLMode value) {
		this.gl = value;
		return this;
	}
	...
	public DisplayOptionsBase(DisplayType type, java.lang.Boolean fullScreen, java.lang.Boolean windowClose, DisplayGLMode gl) {
		this.type = type;
