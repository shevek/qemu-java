 ...
 * Autogenerated class.
 *
 * <pre>QApiTypeDescriptor{name=VncInfo, data={enabled=bool, *host=str, *family=NetworkAddressFamily, *service=str, *auth=str, *clients=[VncClientInfo]}, innerTypes=null}</pre>
 */
