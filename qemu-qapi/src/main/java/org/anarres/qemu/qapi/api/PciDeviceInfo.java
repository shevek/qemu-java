 ...
 * Autogenerated class.
 *
 * <pre>QApiTypeDescriptor{name=PciDeviceInfo, data={bus=int, slot=int, function=int, class_info={*desc=str, class=int}, id={device=int, vendor=int}, *irq=int, qdev_id=str, *pci_bridge=PciBridgeInfo, regions=[PciMemoryRegion]}, innerTypes=null}</pre>
 */
