 ...
 * Autogenerated class.
 *
 * <pre>QApiEnumDescriptor{name=BlockdevDriver, data=[archipelago, blkdebug, blkverify, bochs, cloop, dmg, file, ftp, ftps, host_cdrom, host_device, host_floppy, http, https, null-aio, null-co, parallels, qcow, qcow2, qed, quorum, raw, tftp, vdi, vhdx, vmdk, vpc, vvfat], fields=null}</pre>
 */
