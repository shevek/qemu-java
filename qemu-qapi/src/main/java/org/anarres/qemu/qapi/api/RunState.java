 ...
 * Autogenerated class.
 *
 * <pre>QApiEnumDescriptor{name=RunState, data=[debug, inmigrate, internal-error, io-error, paused, postmigrate, prelaunch, finish-migrate, restore-vm, running, save-vm, shutdown, suspended, watchdog, guest-panicked], fields=null}</pre>
 */
