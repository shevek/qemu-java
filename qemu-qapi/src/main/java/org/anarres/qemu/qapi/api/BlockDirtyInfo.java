 ...
 * Autogenerated class.
 *
 * <pre>QApiTypeDescriptor{name=BlockDirtyInfo, data={*name=str, count=int, granularity=uint32, status=DirtyBitmapStatus}, innerTypes=null}</pre>
 */
// QApiTypeDescriptor{name=BlockDirtyInfo, data={*name=str, count=int, granularity=uint32, status=DirtyBitmapStatus}, innerTypes=null}
