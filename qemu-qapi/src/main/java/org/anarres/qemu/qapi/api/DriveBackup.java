 ...
 * Autogenerated class.
 *
 * <pre>QApiStructDescriptor{name=DriveBackup, data={*job-id=str, device=str, target=str, *format=str, sync=MirrorSyncMode, *mode=NewImageMode, *speed=int, *bitmap=str, *compress=bool, *on-source-error=BlockdevOnError, *on-target-error=BlockdevOnError}, innerTypes=null, fields=null, base=null}</pre>
 */
// QApiStructDescriptor{name=DriveBackup, data={*job-id=str, device=str, target=str, *format=str, sync=MirrorSyncMode, *mode=NewImageMode, *speed=int, *bitmap=str, *compress=bool, *on-source-error=BlockdevOnError, *on-target-error=BlockdevOnError}, innerTypes=null, fields=null, base=null}
...
public class DriveBackup extends QApiType {
	...
	public DriveBackup(java.lang.String jobId, java.lang.String device, java.lang.String target, java.lang.String format, MirrorSyncMode sync, NewImageMode mode, java.lang.Long speed, java.lang.String bitmap, java.lang.Boolean compress, BlockdevOnError onSourceError, BlockdevOnError onTargetError) {
		this.jobId = jobId;
		this.device = device;
		this.target = target;
		this.format = format;
