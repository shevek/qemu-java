 ...
 * Autogenerated class.
 *
 * <pre>QApiStructDescriptor{name=MigrationInfo, data={*status=MigrationStatus, *ram=MigrationStats, *disk=MigrationStats, *xbzrle-cache=XBZRLECacheStats, *total-time=int, *expected-downtime=int, *downtime=int, *setup-time=int, *cpu-throttle-percentage=int, *error-desc=str, *postcopy-blocktime=uint32, *postcopy-vcpu-blocktime=[uint32]}, innerTypes=null, fields=null, base=null}</pre>
 */
...
public class MigrationInfo extends QApiType {
	...
	@SuppressFBWarnings("NP_NONNULL_FIELD_NOT_INITIALIZED_IN_CONSTRUCTOR")
	@JsonProperty("postcopy-blocktime")
	@CheckForNull
	public java.lang.Long postcopyBlocktime;
	@SuppressFBWarnings("NP_NONNULL_FIELD_NOT_INITIALIZED_IN_CONSTRUCTOR")
	@JsonProperty("postcopy-vcpu-blocktime")
	@CheckForNull
	public java.util.List<java.lang.Long> postcopyVcpuBlocktime;
	...
	@Nonnull
	public MigrationInfo withPostcopyBlocktime(java.lang.Long value) {
		this.postcopyBlocktime = value;
		return this;
	}

	@Nonnull
	public MigrationInfo withPostcopyVcpuBlocktime(java.util.List<java.lang.Long> value) {
		this.postcopyVcpuBlocktime = value;
		return this;
	}
	...
	public MigrationInfo(MigrationStatus status, MigrationStats ram, MigrationStats disk, XBZRLECacheStats xbzrleCache, java.lang.Long totalTime, java.lang.Long expectedDowntime, java.lang.Long downtime, java.lang.Long setupTime, java.lang.Long cpuThrottlePercentage, java.lang.String errorDesc, java.lang.Long postcopyBlocktime, java.util.List<java.lang.Long> postcopyVcpuBlocktime) {
		...
		this.postcopyBlocktime = postcopyBlocktime;
		this.postcopyVcpuBlocktime = postcopyVcpuBlocktime;
	}
	...
	public java.util.List<java.lang.String> getFieldNames() {
		...
		names.add("postcopy-blocktime");
		names.add("postcopy-vcpu-blocktime");
		return names;
	}
	...
	public Object getFieldByName(@Nonnull java.lang.String name) throws NoSuchFieldException {
		...
		if ("error-desc".equals(name))
			return errorDesc;
		if ("postcopy-blocktime".equals(name))
			return postcopyBlocktime;
		if ("postcopy-vcpu-blocktime".equals(name))
			return postcopyVcpuBlocktime;
