 ...
 * Autogenerated class.
 *
 * <pre>QApiTypeDescriptor{name=RockerOfDpaFlow, data={cookie=uint64, hits=uint64, key=RockerOfDpaFlowKey, mask=RockerOfDpaFlowMask, action=RockerOfDpaFlowAction}, innerTypes=null}</pre>
 */
// QApiTypeDescriptor{name=RockerOfDpaFlow, data={cookie=uint64, hits=uint64, key=RockerOfDpaFlowKey, mask=RockerOfDpaFlowMask, action=RockerOfDpaFlowAction}, innerTypes=null}
