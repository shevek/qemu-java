...
// QApiTypeDescriptor{name=CpuInfo, data={CPU=int, current=bool, halted=bool, *pc=int, *nip=int, *npc=int, *PC=int, thread_id=int}, innerTypes=null, fields=null}
public class CpuInfo extends QApiObject {
